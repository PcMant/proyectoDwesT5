...
<div class="col-12 row justify-content-center">
            ...
            <form class="col-12 col-sm-12  col-lg-12 col-xl-3 row" action="actualizar.php" >
                <div class="mb-3">
                    <label for="id" class="form-label">Id*</label>
                    <input type="number" class="form-control" id="isbn" name="id" required="required" aria-describedby="id">
                </div>
                <div class="mb-3">
                ...
                <div class="text-center"><button type="submit" class="btn btn-dark w-100">Actualizar libro</button></div>
            </form>
        </div>
